...
export default function Details(props) {
    ...
    return (
        <div className={`w-screen h-screen flex backdrop-blur-[10px]`}>
            <div className={`${!props.darkMode ? 'bg-[#EEEEFF]' : 'bg-[#1A2130] text-white'}  h-[40%] w-[90%] md:w-[30%] rounded-[20px] shadow-[0px_0px_30px_5px_rgba(26,28,38,0.5)] overflow-hidden m-auto`}>
                <button
                ...
                <div className='flex flex-col h-[90%] justify-around overflow-y-scroll pt-[10em] sm:pt-[0px]'>
                    <div className='text-center text-sm sm:text-[1em]'>
                    ...
                    <div className='text-center'>
                        ...
                        <div className='flex justify-center '>
                            {projectsDetails[props.name].techStack.map((item, key) => {
                                return (
                                    <img src={item.icon} alt="" key={key} className='w-[20px] h-[20px] md:w-[50px] md:h-[50px]'/>
                                    )
                                })}
                        </div>
                    </div>
